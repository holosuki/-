...
HD_PWD='E:/UNIVERSITY/alltext/fpga_teris/demo2/demo2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demo2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demo2.tcl
